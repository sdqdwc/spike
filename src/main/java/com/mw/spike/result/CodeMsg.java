...
public class CodeMsg {
	...
	public static CodeMsg PASSWORD_EMTPY = new CodeMsg(500211, "登录密码不能为空");
	public static CodeMsg MOBILE_EMTPY = new CodeMsg(500212, "手机号不能为空");
	public static CodeMsg MOBILE_ERROR = new CodeMsg(500213, "手机号格式为空");
